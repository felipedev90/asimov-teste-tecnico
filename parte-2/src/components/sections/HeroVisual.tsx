...
export function HeroVisual() {
  return (
    <>
      ...
      <div aria-hidden="true" className="block md:hidden">
      ...
      <div aria-hidden="true" className="relative hidden h-[660px] md:block">
        {/* Center glow */}
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        ...
        <ImageClassificationCard className="right-0 lg:right-[-30px] top-[30%] z-20" />

        {/* Data Viz — bottom left */}
        <DataVizCard className="bottom-[60px]  md:left-[-2px] lg:left-[-75px] xl:left-[-28px] z-20" />
